<template>
    <div>
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" class="demo-ruleForm" label-width="100px"><!--model是表单数据对象，rules是表单验证规则-->
            <el-form-item label="Id：" prop="id"><!--prop是表单项对应的数据对象的属性名,可用于编写对应规则-->
                <el-input v-model="ruleForm.id"></el-input><!--v-model是双向绑定的指令，表示将表单项的值与数据对象的属性进行绑定-->
            </el-form-item>
...
export default {
    ...
    created(){
        ...
        this.ruleForm = this.$route.query;//获取路由传递的参数
    }
}
</script>